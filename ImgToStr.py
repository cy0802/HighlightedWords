...
#讀圖片進來
img = cv2.imread(r'img_testdata\93986.jpg')
#轉hsv
hsv = cv2.cvtColor(img, cv2.COLOR_BGR2HSV)
#選取螢光筆區域
Mask = cv2.inRange(hsv,(30,60,100),(35,255,200))

#找螢光筆區域的邊界
contours ,hi = cv2.findContours(Mask,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_SIMPLE)
#找螢光筆區域邊界外的最小長方形
